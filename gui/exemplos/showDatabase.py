...
class App():
    def __init__(self):
        ...
        but = tk.Button(self.root, text="New layer").grid(row=2, column=0, sticky=tk.SE, padx=10)
        but = tk.Button(self.root, text="Delete").grid(row=2, column=0, sticky=tk.SE, pady=30, padx=10)
